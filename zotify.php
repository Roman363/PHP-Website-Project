          ...
          <div class="album travis-scott">
            ...
            <div class="album-info">
              ...
              <!-- <a href="#">ADD SONG</a> -->
                  ...
                  <button name="songname" value="songname" form="addsong">                    
                    Add Song
                  </button>
    ...
    <form method="post" id="addsong">
      ...
      <?php
        ...
        if (isset($_POST['songname'])); {
          ...
          $somefile = fopen("$username/$currentplaylist.txt", "a");
          fwrite($somefile, $songname."\n");
