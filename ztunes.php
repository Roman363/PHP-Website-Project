    ...
    <section class="albums">
      <div class="albums-container">
        <div class="albums-content">
          ...
          <p>Choose what songs you'd like to add.</p>
        </div>
        <div class="albums-cards-container">
          <!-- Jennifer Lopez -->
          <div class="album jennifer-lopez">
            <img src="images/jennifer-lopez.jpg" />
          ...
          <!-- Machine Gun Kelly -->
          <div class="album machine-gun-kelly">
            <img src="images/machine-gun-kelly.jpg" />
            <div class="album-info">
          ...
          <!-- Cold -->
          <div class="album machine-gun-kelly">
            <img src="images/chris-stapleton.jpg" />
            <div class="album-info">
              <h2>Cold</h2>
